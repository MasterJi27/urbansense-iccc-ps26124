...
COVERAGE = [
    ...
    {"id": "vehicles", "requirement": "Vehicle detect / class / count / density", "status": "RULE_BASED", "how": "Azure Vision tags on stills + LOS density. Not ByteTrack on App Service"},
    {"id": "bottlenecks", "requirement": "Traffic bottlenecks", "status": "RULE_BASED", "how": "LOS E/F persistence, not a traffic-forecast model"},
    {"id": "vru", "requirement": "Vulnerable pedestrians / school crossing", "status": "RULE_BASED", "how": "School geofence + speed. Overlay person net is off. Not a child detector"},
